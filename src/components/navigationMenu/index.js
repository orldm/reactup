      ...
      <div className="left-menu">
          ...
          <div className="left-menu-list">
              ...
              <ul className="">
                  ...
                  <li className="menu-list-dashboard"><span className="menu-list-icon icon-marketing"></span>Marketing</li>
          ...
          <div className="left-menu-list">
              ...
              <ul className="">
                  ...
                  <li className="menu-list-dashboard"><span className="menu-list-logo logo-airbnb"></span>Airbnb</li>
